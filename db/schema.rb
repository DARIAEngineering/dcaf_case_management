...
ActiveRecord::Schema[7.1].define(version: 2024_08_12_041841) do
  ...
  create_table "practical_supports", force: :cascade do |t|
    ...
    t.boolean "waiver", comment: "An indicator of whether a patient has signed a waiver or other release paperwork"
    t.date "purchase_date", comment: "Date of purchase of services"
