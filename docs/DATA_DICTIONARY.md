...
**Did Patient have Special Circumstances** | When archived or exported, all special circumstances are purged. Special Circumstances are not exportable. This is a boolean data point to indicate special circumstances were given. Archived Patients prior to 2019-10-21 will always have had_special_circumstances set to null due to a bug in the archiving processing not preserving the value. Archived patients after that date correctly reflect whether or not they had special circumstances. See issue [#1836](https://github.com/DCAFEngineering/dcaf_case_management/issues/1836 "issue #1836") for further context. | Exportable | Autogenerated | Autogenerated
...
**When was pledge sent** | Date autogenerated from the DARIA system when a pledge is sent. | Exportable | Autogenerated | Autogenerated
