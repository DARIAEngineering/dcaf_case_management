...
* Install our version of Ruby! We use version `2.4.4` (Usually `rbenv install 2.4.4` or `rvm install 2.4.4` once you have your version manager set up)
...
* The terminal at the bottom of your new workspace will have a warning message saying "ruby-2.4.4 is not installed. To install do: `rvm install ruby-2.4.4`". Run that command to install the necessary version of Ruby.
