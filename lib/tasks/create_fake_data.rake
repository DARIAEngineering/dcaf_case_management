namespace :db do
  namespace :seed do
    desc 'Generating fake data for data wranglers'
    task :create_fake_data do
        ...
        # Creating fake data 
        # TODO: We need to add calls, external pledges, practical supports, and fulfillments at the least, and also account for the fact that a lot of this stuff is naturally null.
