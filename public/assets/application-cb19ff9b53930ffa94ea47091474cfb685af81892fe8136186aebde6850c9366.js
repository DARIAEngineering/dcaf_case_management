...
(function() {
  jQuery(function() {
    $('#call_list td').each(function(index, element) {
      return $(element).css('width', $(element).width());
    });
    return $('#call_list').sortable({
      ...
      update: function(e, ui) {
        var child, children, item_id, order, parent, value;
...
(function() {
  $(document).on("click", "#toggle-call-log", function() {
    ...
    html = $(".old-calls").hasClass("hidden") ? "View all calls" : "Limit list";
    return $("#toggle-call-log").html(html);
  });

  $(document).on("change", ".edit_pregnancy", function() {
    return $(this).submit();
  });
